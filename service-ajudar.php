...
<head> 
    ...
    <link rel="stylesheet"  href="css/style-service-ajudar.css"   />
...
<section id="banner">
    ...
    <div class="container-banner">
        <div class="rectangle">
            <div class="text">Quero ajudar</div>
        </div>
        ...
        <div class="sub-container-form">
           <div class="col-md-11 mx-auto mb-4">
            ...
            <div class="texts">
                ...
                a. Formação e experiência no área escolhida<br>
                b. Interesse em voluntariado social <br>
    ...
    <div class="container-services">
        ...
        <div class="form">
            ...
            <div class="form">
                ...
                <div class="input">
                    <p>Qual a sua área de formação?* </p>
                ...
                <div class="right">
                    ...
                    <div class="input">
                        <p>UF*</p>
                        <input class="uf" type="text" name="uf" data-rules="required|min=2"  maxlength="2" />
                        ...
                        <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="row ">
                                    ...
                                    <label id="mright" for="area-4">Consultoria de Marketing</label></div>
                                ...
                                <label> Comente sobre a sua experiência na área e indique em quais<br> assuntos relacionados você poderia ajudar.*  </label></br>
